...
VALUES ('admin@xeodocs.com', '$2a$12$Nxa2dwJEPDSlhd6AocP8n.I0wu7tFqGE7/WU1R6bMR2osp9o.UGci', 'Admin User', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
FROM users, roles
WHERE users.email = 'admin@xeodocs.com' AND roles.name = 'admin';
